function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Helix_Fruit_Jump.loader.js";
		var config = {
        dataUrl: buildUrl + "/Helix_Fruit_Jump.data",
        frameworkUrl: buildUrl + "/Helix_Fruit_Jump.framework.js",
        codeUrl: buildUrl + "/Helix_Fruit_Jump.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Helix Fruit Jump",
        productVersion: "1",
      };
